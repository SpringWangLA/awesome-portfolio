...
import nextjs from '../public/experience/nextjs.png'
  ...
  return (
    <div className={darkMode ? 'dark' : ''}>
      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        ...
        <section>
          ...
          <div className='lg:flex gap-10'>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-gray-200 flex-1'>
              ...
              <h3 className='text-lg font-medium pt-8 pb-2'>Programming technology</h3>
              <p className='py-2'>
                Try to learn new technology everyday to satisfy customers' demand.
              </p>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-gray-200 flex-1'>
              ...
              <h4 className="py-4 text-teal-600">Frontend Pack I Use</h4>
        ...
        <section>
          <div>
            <h3 className='text-3xl py-1 dark:text-white'>Skill Set Experience</h3>
          ...
          justify-center w-full dark:bg-gray-200'>
